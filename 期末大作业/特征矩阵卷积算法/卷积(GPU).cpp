...
void Convolution(const float* input, const float* kernel, float* output, int inputSize, int kernelSize) {
...
int main() {
    ...
    Convolution(input, kernel, outputGPU, inputSize, kernelSize);
